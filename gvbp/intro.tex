...
\item In \cref{sec:simple-algos}, we give two simple algorithms for \geomvec{2}{$d$} BP,
...
\item In \cref{chap:gv-rbbp}, we describe a more sophisticated algorithm for \geomvec{2}{$d$} BP,
