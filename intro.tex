...
\begin{subfigure}{0.45\textwidth}
    \centering
    \input{img/1bp-example-b.tikz}
    \caption{A packing of the items into 3 bins.}
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
    \centering
    \input{img/1bp-example-c.tikz}
...
\begin{figure}[htb]
\centering
\input{img/2gbp-example-packed.tikz}
...
\begin{subfigure}{0.45\textwidth}
    \centering
    \input{img/2vbp-example-a.tikz}
    \caption{Five 2D vectors.}
\end{subfigure}
\begin{subfigure}{0.54\textwidth}
    \centering
    \input{img/2vbp-example-b.tikz}
...
into the minimum number of bins. See \cref{fig:2mcbp-example} for an example.

\begin{figure}[htb]
\centering
\input{img/2mcbp-example.tikz}
\caption{2MCBP example: packing the input
$\Ical = \{\{1, 2, 3\}, \{4\}, \{5, 6\}, \{7, 8\}, \{9\}\}$ into two bins.
Here items of the same color belong to the same itemset.}
\label{fig:2mcbp-example}
\end{figure}
